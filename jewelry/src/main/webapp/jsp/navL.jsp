    ...
    <div class="uk-navbar-center"><div> <!--Additional div to display in IE 11-->
        <ul class="uk-navbar-nav"> 
          ...
          <!--USER-->
              ...
              <a href="" uk-icon="icon: user"></a>
                <div class="uk-navbar-dropdown">
                    <ul class="uk-nav uk-navbar-dropdown-nav">
                        <li><a href="orders"><span uk-icon="icon:  list; ratio: 0.8"></span> Twoje zamówienia</a></li>
            ...
            <li><a href="#history" uk-icon="icon:  history" uk-toggle></a></li>
          <!--SZUKAJ-->
            ...
            <li class="uk-parent">  
                ...
                <ul class="uk-nav-sub">
                    ...
                    <li><p class="uk-text-left"><span class="uk-text-small" uk-tooltip="title: ${his.modify}">
                        ${his.description}</span> 
                 <c:if test = "${(his.idAct != 5)&&(his.idAct != 9)}">       
